...
{{- $config := deepCopy .Values.deployment.collectorConfig }}
...
{{- if include "nrKubernetesOtel.lowDataMode" . | default "false" | eq "false" }}
    ...
    {{- range $processors }}
        {{- if not (or (eq . "k8s_cluster_info_ldm") (eq . "metricstransform/ldm") (eq . "metricstransform/k8s_cluster_info_ldm") (eq . "metricstransform/apiserver") (eq . "filter/exclude_metrics_low_data_mode") (eq . "transform/low_data_mode_inator") (eq . "resource/low_data_mode_inator")) }}
